  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 24px 80px' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: 44 }}>
        <div className="section-badge animate-fadeUp" style={{ marginBottom: 16 }}>📋 Available Tests</div>
              ...
              <div style={{ padding: '20px 22px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
                <div style={{ flex: 1, minWidth: 200 }}>
                  ...
                  <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                    ...
                    <span style={{ background: 'var(--off-white)', border: '1px solid rgba(10,61,31,0.1)', borderRadius: 8, padding: '4px 10px', fontSize: 11, fontWeight: 600, color: 'var(--text-muted)' }}>⏱ {test.time_limit} minutes</span>
                    <span style={{ background: 'var(--off-white)', border: '1px solid rgba(10,61,31,0.1)', borderRadius: 8, padding: '4px 10px', fontSize: 11, fontWeight: 600, color: 'var(--text-muted)' }}>📝 {test.question_count ?? '?'} questions</span>
